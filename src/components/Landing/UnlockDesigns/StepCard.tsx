...
export default function StepCard({
  ...
  if (isMobileVertical) {
    return (
      ...
      >
        <div className="relative inline-flex overflow-hidden rounded-xl p-[1px] w-full">
          ...
          <div className="relative bg-zinc-900/95 backdrop-blur-sm rounded-xl p-4 w-full hover:shadow-lg hover:shadow-orange-500/20 transition-all">
            <div className="flex items-start gap-4">
              {/* Colonna sinistra: Numero + Contenuto */}
              <div className="flex-1 flex gap-4">
                {/* Numero con cerchio shader e glow */}
              ...
              {/* Icona a destra */}
              <div
                className={`w-12 h-12 rounded-lg bg-gradient-to-br ${color} flex items-center justify-center shadow-lg flex-shrink-0`}
              >
    ...
    >
      <div className="relative">
        ...
        <div className="relative inline-flex overflow-hidden rounded-xl p-[1px]">
          ...
          {/* Card content */}
          <div className="relative bg-zinc-900/95 backdrop-blur-sm rounded-xl p-5 w-52 hover:shadow-lg hover:shadow-orange-500/20 transition-all flex flex-col items-start">
            {/* Header */}
            ...
            <h3 className="text-white font-bold text-base mb-2 text-left">
              {title}
            </h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              {description}
