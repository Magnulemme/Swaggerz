...
export function CollaborationsSubtitle() {
  ...
  return (
    ...
    >
      ...
      {/* Description */}
      <p className="text-sm md:text-base text-light-tertiary max-w-prose mx-auto leading-relaxed">
        Drop limitati e partnership uniche con i migliori brand streetwear
      </p>
    </motion.div>
  );
}
