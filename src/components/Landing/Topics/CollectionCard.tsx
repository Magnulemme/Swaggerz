          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 px-8 text-center">
            ...
            {subtitle && (
              <motion.span
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-brand/30 bg-brand/10 text-brand text-xs font-bold uppercase tracking-wider backdrop-blur-sm"
              >
                {subtitle}
              </motion.span>
            )}
    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="text-zinc-400 text-sm lg:text-base mb-8 leading-relaxed"
        >
