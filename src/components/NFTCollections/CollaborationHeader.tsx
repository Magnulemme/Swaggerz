...
export default function CollaborationHeader({
  ...
  return (
    ...
    >
      {/* Mobile Layout: Stacked logos + names below */}
      <div className="flex md:hidden flex-col gap-2">
        {/* Overlapping Logos - Compact width for tag space */}
        <div className="flex items-center w-fit">
          ...
          >
            <span className="font-[family-name:var(--font-pastor-of-muppets)] text-xl">
              {brand1.letter}
            </span>
          </div>
          {/* Brand 2 Logo - Overlapping */}
          <div
            className="relative w-11 h-11 rounded-full flex items-center justify-center shadow-lg -ml-3"
        ...
        {/* Names below - Can be wider */}
        <div className="flex items-center gap-1.5 pl-0.5">
          <span className="text-base md:text-lg font-black text-white">
            {brand1.name}
          </span>
          <span className="text-amber-500 font-black text-lg md:text-xl">✕</span>
          <span
